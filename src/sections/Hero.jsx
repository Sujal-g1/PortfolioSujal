...
const Hero = () => {
    ...
    const aboutText = `I make creative websites that feels real`
  ...
  return (
    ...
    <p className="text-sm font-light tracking-[0.3rem] sm:tracking-[0.5rem] uppercase px-10 text-black">404 No Bugs Found</p> 
    <div className="sm:px-10 px-6 pb-2 ">
    <h1 className="flex flex-col flex-wrap gap-12 text-black uppercase banner-text-responsive sm:gap-16 md:block">Sujal Garg</h1>
    </div>
     </div>
    </div>
